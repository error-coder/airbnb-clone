...
class KakaoLogIn(APIView):
    ...
    def post(self, request):
        try:
            code = request.data.get("code")
            access_token = requests.post("https://kauth.kakao.com/oauth/token", headers={"Content-Type": "application/x-www-form-urlencoded"}, data={"grant_type" :"authorization_code", "client_id":"00e2d9ca68d4023005c8b0221ad6a6de", "redirect_url":"http://127.0.0.1:3000/social/kakao","code":code,},)
            access_token = access_token.json().get("access_token")
